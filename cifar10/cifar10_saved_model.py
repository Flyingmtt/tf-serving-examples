...
import cifar10 as cifar_model

tf.app.flags.DEFINE_string('checkpoint_dir', '/tmp/cifar10_train',
                           """Directory where to read training checkpoints.""")
tf.app.flags.DEFINE_string('output_dir', '/tmp/cifar10_output',
...
def export():
  with tf.Graph().as_default():
    ...
    class_tensor = tf.constant(['airplane','automobile','bird','cat','deer','dog','frog','horse','ship','truck'])
